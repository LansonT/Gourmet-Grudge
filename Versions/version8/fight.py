...
def player():
    ...
    #print(important.current_time - important.last_attack[0])
    #blocking
    #elif player holds "S":
...
def bot():
    ...
    if important.current_time - important.last_attack[1] >= important.attack_time[1] * 1000 and not important.animate:
    ...
    #attacking
                ...
                important.animate = True
                important.animation_timer[1] = important.current_time
                visuals.Bot_Attack[important.Bot_Attack] = True
                print("bot attacking")
    
    if important.animate:
        bot_attack(important.Bot_Attack)
