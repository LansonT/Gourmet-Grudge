...
def new_arena():
    global W_Key, W_x, W_y, W_timer, W_active
    global A_Key, A_x, A_y, A_timer, A_active
    global D_Key, D_x, D_y, D_timer, D_active
    ...
    if Block_Keys[1]:
        ...
        screen.blit(right_block, ((important.SCREEN_WIDTH - left_block.get_width()) // 2 + 100, important.SCREEN_HEIGHT - right_block.get_height() - 50))  # Display 100 pixels above the bottom
